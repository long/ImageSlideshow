...
open class ImageSlideshow: UIView {
     ...
     */
    @discardableResult
    open func presentFullScreenController(from controller: UIViewController, modalPresentationStyle: UIModalPresentationStyle = .overFullScreen) -> FullScreenSlideshowViewController {
        ...
        fullscreen.modalPresentationStyle = modalPresentationStyle
